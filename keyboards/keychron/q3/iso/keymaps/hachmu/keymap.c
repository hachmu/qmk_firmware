...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [FN] = LAYOUT_tkl_iso(
        ...
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,    _______,  _______,  _______,  KS_WH_U,
        RGB_TOG,  _______,  RGB_VAI,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,              _______,  _______,  KS_WH_D,
        _______,  _______,  RGB_VAD,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,    KS_BTN1,
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,              KS_BTN2,            KC_MS_UP,
        _______,  GU_TOGG,  _______,                                _______,                                _______,  _______,  _______,    KS_BTN3, KC_MS_LEFT,KC_MS_DOWN,KC_MS_RIGHT),
